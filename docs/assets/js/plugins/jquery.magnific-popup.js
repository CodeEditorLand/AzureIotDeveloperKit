...
((factory) => {
		...
		if (typeof options === "string") {
			if (options === "open") {
				var items,
					...
					index = Number.parseInt(arguments[1], 10) || 0;
		...
		proto: {
			...
			resizeImage: () => {
				...
				if (mfp.st.image.verticalFit) {
					...
					if (mfp.isLowIE) {
						decr =
							Number.parseInt(item.img.css("padding-top"), 10) +
							Number.parseInt(item.img.css("padding-bottom"), 10);
					}
	...
	$.magnificPopup.registerModule("zoom", {
		...
		proto: {
			...
			_allowZoom: () => mfp.currItem.type === "image",
			...
			_getOffset: (isLarge) => {
				...
				var paddingTop = Number.parseInt(el.css("padding-top"), 10);
				var paddingBottom = Number.parseInt(
