...
"undefined" != typeof window ? window : this,
	(e, t) => {
		...
		var ee = [],
			...
			de = ue.call(Object),
			fe = {},
			pe = (e, t) => new pe.fn.init(e, t),
			he = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
			me = /^-ms-/,
			ge = /-([a-z])/g,
			ve = (e, t) => t.toUpperCase();
		(pe.fn = pe.prototype =
			{
				jquery: "3.2.1",
				constructor: pe,
			...
			pe.extend({
				...
				when: (e) => {
					...
					if (
						...
						"pending" === o.state() ||
							pe.isFunction(r[n] && r[n].then))
					)
						return o.then();
					while (n--) u(r[n], a(n), o.reject);
					return o.promise();
				},
			});
		...
		var je = (e, t, n, i, r, o, a) => {
			...
			De = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
		(f.uid = 1),
			(f.prototype = {
				cache: function (e) {
		...
		(pe.event = {
				...
				if (g && (l = g.events)) {
					for (c = (t = (t || "").match(Ie) || [""]).length; c--; )
						if (
							...
							for (p in l) pe.event.remove(e, p + t[c], n, i, !0);
			...
			dispatch: function (e) {
				...
				if (
					...
					return (
						u.postDispatch && u.postDispatch.call(this, s), s.result
					);
				}
			},
		...
		pe.extend({
			...
			pe.each(
				...
				(e, t) => {
					pe.fn[e] = function (e) {
						for (
							var n, i = [], r = pe(e), o = r.length - 1, a = 0;
							a <= o;
							a++
						)
	...
	((e, t, n) => {
		...
		var o = {
			...
			a = (() => {
					...
					i = (e, n, i) => {
						for (
							...
							(o.pixelRatio &&
								...
								(o.deviceOrientation &&
									o.deviceOrientation !== s) ||
								(o.windowOrientation &&
									o.windowOrientation !== s) ||
				...
				return (t, o) => {
					for (
						var a = t.width(), s = t.height(), l = [], c = 0;
						c < o.length;
						c++
					)
						if (e.isArray(o[c])) {
		...
		p.prototype = {
			resize: function () {
				try {
					var n = this.options.alwaysTestWindowResolution
							? e(t)
							: this.$root,
						r = n.width(),
						o = n.height(),
						s = r / (this._lastResizeContainerWidth || 0),
						c = o / (this._lastResizeContainerHeight || 0),
						u = this.options.resolutionChangeRatioThreshold || 0;
					if (
					...
					var f,
						p,
						h = { left: 0, top: 0, right: "auto", bottom: "auto" },
						m = this.isBody
							? this.$root.width()
						...
						v = this.$itemWrapper.data("width"),
						y = this.$itemWrapper.data("height"),
						b = v / y || 1,
						x =
						...
						C = i(this._currentImage.scale || this.options.scale);
					...
					var k = e.Event("backstretch.resize", {
			...
			show: function (t, n) {
				if (!(Math.abs(t) > this.images.length - 1)) {
					...
					i.$container.trigger(e.Event("backstretch.before", l), [
						...
						(this.index = t);
					var c = i.images[t];
					clearTimeout(i._cycleTimeout), delete i.videoWrapper;
					var u = s(c);
					return (
						u
			...
			cycle: function () {
				if (this.images.length > 1) {
					...
					var t =
							(this._currentImage &&
								this._currentImage.duration) ||
							this.options.duration,
						n = s(this._currentImage),
						i = function () {
							this.$item.off(".cycle"),
		...
		(m.prototype.init = function (n) {
			var i,
				...
				s = "video";
			if (
				(n.url instanceof Array || !r.test(n.url) || (s = "youtube"),
				(this.type = s),
				"youtube" === s)
			) {
				...
				var l =
					...
					encodeURIComponent(t.location.origin);
				...
				for (
					var c = n.url instanceof Array ? n.url : [n.url], u = 0;
					u < c.length;
					u++
				) {
					var d = c[u];
	...
	((e) => {
		...
		e.fn.extend({
			scrollable: function (e) {
				var t = i.call(this, { dir: e });
				return this.pushStack(t);
			},
			firstScrollable: function (e) {
				var t = i.call(this, { el: "first", dir: e });
				return this.pushStack(t);
			},
			...
			c.px
				...
				(u = c.px
					...
					: {
							...
							px:
								(e(r.scrollTarget)[f]() &&
									e(r.scrollTarget)[f]()[r.direction]) ||
								0,
					  }),
	...
	((e, t, n) => {
		(e.devKitExtends = () => {
			...
			if (e(".switcher").length > 0) {
				var a = e(".switcher").next().prop("tagName");
				"H" != a[0]
					? e(".switcher").remove()
					: ((a = a[1]),
		...
		var i = () => {
				var n = () => {
					var n = e(".page__content").position().top;
					n > e(t).scrollTop()
				...
				e(".page__content").length &&
					(n(), e(t).scroll(n), e(t).resize(n));
			},
			r = function () {
			...
			a = function () {
				if (e(".sidebar__right_fix").length)
					if (t.innerWidth >= 1024) {
						var n = e(".page__content").position(),
							i = n.left + e(".page__content").width();
						if (t.innerWidth < 1280) {
							var r = document.body.clientWidth - i - 30;
							e(".sidebar__right_fix").css("width", r);
						} else e(".sidebar__right_fix").removeAttr("style");
					...
					e(this).css("cursor", "pointer"),
						e(this).click(function (t) {
							...
							if (
								...
								var i = e(this).find(".archive__item-title a");
								i.length && c(i[0]);
							}
						});
				});
			...
			f = () => {
				e("p.project-difficulty").each(function () {
					var t = e(this).html().trim().toLocaleLowerCase();
					"easy" == t
			...
			p = () => {
				if (
					...
					var n = e(".page__content").children();
					if (n.length) {
						var i = n[0];
						e(".page__content")
							.children("h2, h3")
