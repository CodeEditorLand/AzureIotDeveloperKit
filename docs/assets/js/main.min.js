...
"undefined" != typeof window ? window : this,
	function (e, t) {
		...
		pe.extend({
			hasData: function (e) {
				return Oe.hasData(e) || Pe.hasData(e);
			},
			data: function (e, t, n) {
		...
		pe.extend({
			...
			(pe.cssHooks.marginLeft = P(
				fe.reliableMarginLeft,
				function (e, t) {
					if (t)
						return (
	...
	(function (e, t, n) {
		...
		(e.fn.backstretch = function (n, i) {
			...
			(e.expr[":"].backstretch = function (t) {
				return void 0 !== e(t).data("backstretch");
			}),
			...
			resize: function () {
				try {
					...
					if (
						...
						var d = this;
						clearTimeout(d._selectAnotherResolutionTimeout),
							(d._selectAnotherResolutionTimeout = setTimeout(
								function () {
									d.show(0);
								},
		...
		(m.prototype.init = function (n) {
			...
			if (
				...
				m.loadYoutubeAPI(), (o.ytId = n.url.match(r)[2]);
				var l =
				...
				(o.__ytStartMuted = !!n.mute || void 0 === n.mute),
					(i = e("<iframe />")
						.attr({ src_to_load: l })
						.css({ border: 0, margin: 0, padding: 0 })
						.data("player", o)),
					n.loop &&
						i.on("ended.loop", function () {
							o.__manuallyStopped || o.play();
						}),
					(o.ytReady = !1),
					a(),
					t.YT
						? (o._initYoutube(), i.trigger("initsuccess"))
						: e(t).one("youtube_api_load", function () {
								o._initYoutube(), i.trigger("initsuccess");
						  });
			} else {
				i = e("<video>")
			...
			(m.prototype._initYoutube = function () {
				var n = this,
					i = t.YT;
				n.$video
					.attr("src", n.$video.attr("src_to_load"))
					.removeAttr("src_to_load");
				var r = !!n.$video[0].parentNode;
				if (!r) {
					var o = e("<div>")
				...
				var a = new i.Player(n.video, {
					events: {
						onReady: function () {
							n.__ytStartMuted && a.mute(),
								r ||
									(n.$video[0].parentNode === o[0] &&
										n.$video.detach(),
									o.remove()),
								(n.ytReady = !0),
								n._updateYoutubeSize(),
								n.$video.trigger("canplay");
						},
						onStateChange: function (e) {
							switch (e.data) {
								case i.PlayerState.PLAYING:
									n.$video.trigger("playing");
									break;
								case i.PlayerState.ENDED:
									n.$video.trigger("ended");
									break;
								case i.PlayerState.PAUSED:
									n.$video.trigger("pause");
									break;
								case i.PlayerState.BUFFERING:
									n.$video.trigger("waiting");
									break;
						...
						onPlaybackQualityChange: function () {
							n._updateYoutubeSize(), n.$video.trigger("resize");
						},
						onError: function (e) {
							(n.hasError = !0),
								n.$video.trigger({ type: "error", error: e });
						},
					},
				});
				return (n.ytPlayer = a), n;
			}),
			(m.prototype._updateYoutubeSize = function () {
				var e = this;
				switch (e.ytPlayer.getPlaybackQuality() || "medium") {
					case "small":
						(e.video.videoWidth = 426), (e.video.videoHeight = 240);
						break;
					case "medium":
						(e.video.videoWidth = 640), (e.video.videoHeight = 360);
						break;
					default:
					case "large":
						(e.video.videoWidth = 854), (e.video.videoHeight = 480);
						break;
					case "hd720":
						...
						break;
					case "hd1080":
						(e.video.videoWidth = 1920),
							(e.video.videoHeight = 1080);
						break;
					case "highres":
						(e.video.videoWidth = 2560),
							(e.video.videoHeight = 1440);
				}
				return e;
			}),
			(m.prototype.play = function () {
				var e = this;
				return (
					(e.__manuallyStopped = !1),
					"youtube" === e.type
						? e.ytReady &&
						  (e.$video.trigger("play"), e.ytPlayer.playVideo())
						: e.video.play(),
					e
				);
			}),
			(m.prototype.pause = function () {
				...
				return (
					(e.__manuallyStopped = !1),
					"youtube" === e.type
						? e.ytReady && e.ytPlayer.pauseVideo()
						: e.video.pause(),
					e
				);
			}),
			(m.prototype.stop = function () {
				var e = this;
				return (
					(e.__manuallyStopped = !0),
					"youtube" === e.type
						? e.ytReady &&
						  (e.ytPlayer.pauseVideo(), e.ytPlayer.seekTo(0))
						: (e.video.pause(), (e.video.currentTime = 0)),
					e
				);
			}),
			(m.prototype.destroy = function () {
				var e = this;
				return e.ytPlayer && e.ytPlayer.destroy(), e.$video.remove(), e;
			}),
			...
			(m.prototype.setCurrentTime = function (e) {
				...
				return (
					"youtube" === t.type
						? t.ytReady && t.ytPlayer.seekTo(e, !0)
			...
			(m.prototype.getDuration = function () {
				...
				return "youtube" !== e.type
					? e.video.duration
					: e.ytReady
					  ? e.ytPlayer.getDuration()
					  : 0;
			}),
			(m.loadYoutubeAPI = function () {
				if (!t.YT) {
	...
	(function (e, t, n) {
		(e.devKitExtends = function () {
			...
			(e.closeReportIssue = function () {
				e("#surveypopup").remove();
			}),
			(e.reportIssuePopup = function (t, n) {
				e("body").append(
			...
			(e.reportIssue = function () {
				e(".feedback-btns").fadeOut(400, function () {
			...
			(e.feedbackDisappeared = function () {
				e(".feedback-btns").fadeOut(400, function () {
					e(".feedback-btns")
						.html(
			...
			(e.feedbackButtonClick = function (e, t) {
				try {
					ga("send", "event", {
			...
			p = function () {
				if (
					...
					e(".faq-back-to-top").css(
						...
						e(t).scroll(h),
						e(".faq-back-to-top").click(function () {
							return e("body").animate({ scrollTop: 0 }, 500), !1;
						});
				}
			},
			h = function () {
